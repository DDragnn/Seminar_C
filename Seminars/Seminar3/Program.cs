...
// Console.WriteLine($"Distance between our point --> {FindDistance(xa, ya, xb, yb)}");
...
// if(c == 1) return 1 Console.WriteLine(" x > 0 & y>0");

// if(c == 2) return 2 Console.WriteLine(" x < 0 & y > 0");
// if(c == 3) return 3 Console.WriteLine(" x < 0 & y < 0");
// if(c == 4) return 4 Console.WriteLine(" x > 0 & y < 0");
// return 0;
// }
// Console.WriteLine(ThreadInterruptedException c: );
// int c = 

// void FindDiapazon ( int c)
//     {
